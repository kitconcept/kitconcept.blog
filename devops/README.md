...
```
DEPLOY_ENV=prod
DEPLOY_HOST=kitconcept-blog.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    kitconcept-blog.example.com:
      ansible_user: root
      host: kitconcept-blog
      hostname: kitconcept-blog.example.com
```
...
Deploy the stack defined in `devops/stacks/kitconcept-blog.example.com.yml` to the remote server with:
